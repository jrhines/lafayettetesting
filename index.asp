...
<div id="homeColumns">
	...
	<div id="rightColumn">
		<map name="servicesMap">
			...
			<area alt="Complimentary Services" shape="poly" coords="87,151,88,87,142,124,123,144" href="<%=address%>services/index.asp?serviceType=complimentary">
			<area alt="Liquid Penetrant" shape="poly" coords="34,123,89,85,87,153,59,149" href="<%=address%>services/index.asp?serviceType=liquidPenetrant">
